    ...
    return (
        <section id="Project">
            ...
            <div className="flex flex-col gap-10">
                <ProjectItems src="portfolio.jpg" name="Personal Portfolio" detail0="The project you see is my first ever porfolio made from scratch." detail1="Some tech stack used in this project has been used for the very first time." detail2=" Due to it i got to learn a lot of typescript." link="https://harshal-ishere.vercel.app/" />
